...
- **GitHub Issues**: [Создать issue](https://github.com/igornet0/SAMe/issues)
- **Email**: 93836464+igornet0@users.noreply.github.com
- **Документация**: [GitHub Pages](https://igornet0.github.io/SAMe/)

---

**SAMe** - Делаем поиск аналогов простым и эффективным! 🔍✨

*Разработано с ❤️ для инженеров и специалистов по закупкам*
